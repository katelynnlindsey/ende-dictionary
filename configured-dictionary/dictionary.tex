...
\entry{aba}{\headword{aba}\pos{interj.}\etymology{clipping ofabäll}\definition{go (command given to animals)}}
...
\entry{abe}{\headword{abe}\pos{coord.}\etymology{a + be}\sensenumber{2}\definition{but}}
...
\entry{ama2}{\headword{ama2}\pos{n.}\etymology{from Englishhammer}\sensenumber{2}\definition{hammer}}
...
\entry{apte gabän}{\headword{apte gabän}\pos{num.}\etymology{lit. 'other wrist'}\sensenumber{3}\definition{fourteen (body counting numeral)}}
\entry{apte kllatolma}{\headword{apte kllatolma}\pos{num.}\etymology{lit. 'other middle finger'}\sensenumber{3}\definition{seventeen (body counting numeral)}}
\entry{apte matta}{\headword{apte matta}\pos{num.}\etymology{lit. 'other shoulder'}\sensenumber{3}\definition{twelve (body counting numeral)}}
\entry{apte mända}{\headword{apte mända}\pos{num.}\etymology{lit. 'other thumb'}\sensenumber{3}\definition{fifteen (body counting numeral)}}
\entry{apte mätkin}{\headword{apte mätkin}\pos{num.}\etymology{lit. 'other ring finger'}\sensenumber{3}\definition{eighteen (body counting numeral)}}
\entry{apte ngam}{\headword{apte ngam}\pos{num.}\etymology{lit. 'other breast'}\sensenumber{3}\definition{eleven (body counting numeral)}}
\entry{apte tärangesa}{\headword{apte tärangesa}\pos{num.}\etymology{lit. 'other pinky'}\sensenumber{3}\definition{nineteen (body counting numeral)}}
\entry{apte tupi}{\headword{apte tupi}\pos{num.}\etymology{lit. 'other index finger'}\sensenumber{3}\definition{sixteen (body counting numeral)}}
\entry{apte ttang kum}{\headword{apte ttang kum}\pos{num.}\etymology{lit. 'other elbow'}\sensenumber{3}\definition{thirteen (body counting numeral)}}
...
\entry{au}{\headword{au}\pos{n.}\etymology{au + ma}\sensenumber{1}\definition{burial}\example{Au ddägattalle lla da tämamae ma we dingismällalle.}{After the burial, all the people return home.}\sensenumber{2}\definition{to bury}\example{Kuddäll pätt de au dägagallo.}{They will bury the body.}\sensenumber{2}\definition{grave}\example{Mällause bo auma da dan de.}{The old woman's grave is there.}\subentry{\headword{auma}\pos{n.}\definition{grave}}}
...
\entry{Australia}{\headword{Australia}\pos{pn.}\etymology{from EnglishAustralia}\sensenumber{2}\definition{Australia}}
...
\entry{awe2}{\headword{awe2}\pos{n.}\etymology{probably from Idiawea}\sensenumber{2}\definition{cassowary (used when hunting)}}
...
\entry{baebol}{\headword{baebol}\pos{n.}\etymology{from EnglishBible}\sensenumber{3}\definition{Bible}}
...
\entry{=bakmall}{\headword{=bakmall}\pos{n. cl.}\etymology{contr. of =aba + =kämall}\sensenumber{3}\definition{comitative case clitic; with (only used after oba, ama, and nouns followed by =aba)}\example{Ngämi oba bakmall eka tameny amalla.}{We (excl.) discussed with them.}\example{Ge lla da ngäna ama bakmall skul att dan.}{These people are who I went to school with.}\example{Inggoemeny e bog tongoenen e bägne, bogmam nagnag aba bakmall.}{We will tell jokes with our friends.}}
...
\entry{batri}{\headword{batri}\pos{n.}\etymology{from Englishbattery}\sensenumber{2}\definition{battery}\sensenumber{2}\definition{battery}\subentry{\headword{batri käp}\pos{n.}\definition{battery}}}
...
\entry{bägäbägäl}{\headword{bägäbägäl}\pos{n.}\etymology{redup. ofbägäl}\sensenumber{3}\definition{Achilles/calcaneal tendon (on the back of ankle)}}
...
\entry{bällämbäll}{\headword{bällämbäll}\pos{n.}\etymology{redup. of bälläm + =meny}\sensenumber{2}\definition{thought}\sensenumber{2}\definition{thoughtless, apathetic, uncaring}\example{Däbe lla da eran lla bällämbällämmeny dan.}{That man doesn't care about others.}\subentry{\headword{bällämbällämmeny}\pos{mod.}\definition{thoughtless, apathetic, uncaring}}}
...
\entry{bärkebärke}{\headword{bärkebärke}\pos{n.}\etymology{redup. of bärke}\sensenumber{2}\definition{type of algae that can be red or green like a parrot}}
...
\entry{bebi}{\headword{bebi}\pos{n.}\etymology{from Englishbaby}\sensenumber{2}\definition{baby}\example{Bebi da ngänaeka allan.}{The baby is crying.}}
...
\entry{bel}{\headword{bel}\pos{n.}\etymology{from Englishbell}\sensenumber{2}\definition{bell}}
...
\entry{bin}{\headword{bin}\pos{n.}\etymology{bin+ =ang}\sensenumber{2}\definition{name}\example{Ngämo mälla bo bin a Kristina.}{My wife's name is Kristina.}\sensenumber{2}\definition{namesake}\sensenumber{2}\definition{serious}\example{ulle binang itrell peyang lla}{seriously ill person}\subentry{\headword{binang1}\pos{n.}\definition{namesake}}\subentry{\headword{binang2}\pos{mod.}\definition{serious}}}
...
\entry{bisnis}{\headword{bisnis}\pos{n.}\etymology{from Englishbusiness}\sensenumber{2}\definition{business}}
...
\entry{blengud}{\headword{blengud}\pos{n.}\etymology{from Englishblanket}\sensenumber{2}\definition{blanket}}
...
\entry{bod}{\headword{bod}\pos{n.}\etymology{lit. 'mouth skin'}\sensenumber{1}\definition{mouth}\example{Ngäna mɨnyi mälläng ik dae beyazen a bod ik dae bigezän.}{I will put it in through your nostrils and take it out through your mouth.}\example{Mällaeyaba bod me dan.}{It's on the women's lips (i.e. the subject of gossip).}\sensenumber{2}\definition{beak}\example{Bod a malla ddäddäg ma dan.}{The beak is not edible.}\sensenumber{3}\definition{lip of bag (braid that goes along the rim of the bag to finish it)}\sensenumber{3}\definition{lip}\subentry{\headword{bod ttoe}\pos{n.}\definition{lip}}}
...
\entry{bol}{\headword{bol}\pos{n.}\etymology{from Englishball}\sensenumber{3}\definition{ball}}
...
\entry{bott}{\headword{bott}\pos{n.}\etymology{from Englishboat}\sensenumber{2}\definition{boat}}
...
\entry{buk}{\headword{buk}\pos{n.}\etymology{from Englishbook}\sensenumber{3}\definition{book}\example{buk ulle}{big book}}
...
\entry{bunkombunkom}{\headword{bunkombunkom}\pos{n.}\etymology{redup. ofbunkom}\sensenumber{4}\definition{type of tall, big tree that grows along creek with wood used for canoes}}
...
\entry{daga}{\headword{daga}\pos{n.}\etymology{from Tok Pisindaka}\sensenumber{2}\definition{betel}}
...
\entry{damona}{\headword{damona}\pos{num.}\etymology{from a Yam language; compare Nen damno}\sensenumber{2}\definition{1296 (yam counting numeral; 6\textbackslashtextasciicircum4)}}
...
\entry{dändär2}{\headword{dändär2}\pos{S vt.}\etymology{dändär + =att}\sensenumber{3}\definition{to stuff}\example{Mänmän a sana de zazaba we dändäraebeyo.}{The girls stuffed the sago into the bag.}\sensenumber{3}\definition{bagful of sago}\allomorph{ndär}\allomorph{därmäll}\subentry{\headword{dändäratt}\pos{n.}\definition{bagful of sago}}}
...
\entry{därängbun}{\headword{därängbun}\pos{n.}\etymology{däräng + bun, lit. 'dog head'}\sensenumber{2}\definition{type of pandanus with a curved fruit shaped like a dog's head Wätät ma mab dan, ulle käpang dan. (It's an edible pandanus with large fruit.)}}
...
\entry{däränggedärängge}{\headword{däränggedärängge}\pos{n.}\etymology{redup. of därängge}\sensenumber{2}\definition{large wild orchid}}
...
\entry{dedi}{\headword{dedi}\pos{kin.}\etymology{from Englishdaddy}\sensenumber{2}\definition{daddy}}
...
\entry{dektta}{\headword{dektta}\pos{n.}\etymology{from Englishdoctor}\sensenumber{2}\definition{doctor}\example{Ubi mɨnyi dektta we moko bognegän.}{They will want a doctor.}}
...
\entry{didri}{\headword{didri}\pos{adv. dem.}\etymology{didri + =att}\sensenumber{3}\definition{there}\example{Da ngäna sawe nyongo de bongkollmäll, ngaska didri lla da ddone dan.}{If I follow the left road, maybe there won't be any people there.}\sensenumber{3}\definition{ablative form of didri}\example{Ngämi didribatt dag Boze att dag.}{We (excl.) are from there, from Boze.}\subentry{\headword{didribatt}\pos{adv. dem.}\definition{ablative form of didri}}}
...
\entry{digodigol}{\headword{digodigol}\pos{n.}\etymology{partial redup. of digol}\sensenumber{3}\definition{type of tree}}
...
\entry{dikun}{\headword{dikun}\pos{n.}\etymology{from Englishdeacon}\sensenumber{3}\definition{deacon}}
...
\entry{dinidini}{\headword{dinidini}\pos{n.}\etymology{redup. of dini}\sensenumber{2}\definition{type of small tree that grows in the bush with red fruit}}
\entry{dinggel}{\headword{dinggel}\pos{n.}\sensenumber{2}\definition{sugar glider}}
\entry{dinggi}{\headword{dinggi}\pos{n.}\etymology{from Englishdinghy}\sensenumber{2}\definition{dinghy}}
...
\entry{dirom}{\headword{dirom}\pos{n.}\etymology{lit. 'kill the cassowary'}\sensenumber{2}\definition{southern cassowary Wälläng me giddollag ddäddäg ulle dan. (It's a large game animal that lives in the bush.)}\example{Dirom a ttongo mer mokowang ddäddäg dan.}{Cassowary is a very delicious animal.}\sensenumber{2}\definition{cassowary egg}\sensenumber{2}\definition{to menstruate for the first time}\subentry{\headword{dirom käp1}\pos{n.}\definition{cassowary egg}}\subentry{\headword{dirom gäz}\pos{S vt.}\definition{to menstruate for the first time}}}
\entry{dirom käp2}{\headword{dirom käp2}\pos{n.}\etymology{lit. 'cassowary egg'}\sensenumber{2}\definition{type of small taro}}
...
\entry{diromdirom}{\headword{diromdirom}\pos{n.}\etymology{redup. of dirom}\sensenumber{2}\definition{type of small tree with round, flat, edible fruit that are green and red when ripe}}
\entry{distrik}{\headword{distrik}\pos{n.}\etymology{from Englishdistrict}\sensenumber{2}\definition{district}}
...
\entry{dompadompa}{\headword{dompadompa}\pos{n.}\etymology{redup. of dompa}\sensenumber{2}\definition{type of spear}}
...
\entry{dongki}{\headword{dongki}\pos{n.}\etymology{from Englishdonkey}\sensenumber{2}\definition{donkey}}
...
\entry{doros}{\headword{doros}\pos{n.}\etymology{from Englishdrawers}\sensenumber{2}\definition{pants}}
...
\entry{duli}{\headword{duli}\pos{adv. dem.}\etymology{duli + =alle₂}\sensenumber{1}\definition{over there (distal)}\example{Obo ma da duli dan kona me dan.}{His house is over there on the corner.}\example{Duli dan ddob ttängäm me dan.}{She is over there, somewhere else.}\sensenumber{2}\definition{away (from a place towards another direction)}\example{Ine da däbe llɨg kälsre de dätramän duli.}{The water carried the little boy away.}\example{Duli abäll bibi.}{You all, go away.}\sensenumber{2}\definition{that way}\example{Llɨg a duduli ibi allan.}{The boy is going that way.}\sensenumber{2}\definition{ablative form of duli}\example{Ubi duliduli gobällän a ako duliballe ngäsmäll eran.}{They had migrated far away and are now returning from there.}\sensenumber{2}\definition{ablative form of duli}\example{Obo masar a dulibatta deyarän gänyaolle.}{His grandfather came here from over there.}\subentry{\headword{duduli}\pos{adv.}\definition{that way}}\subentry{\headword{duliballe}\pos{adv.}\definition{ablative form of duli}}\subentry{\headword{dulibattäm}\pos{adv. dem.}\definition{ablative form of duli}}}
...
\entry{ddapall}{\headword{ddapall}\pos{n.}\etymology{lit. 'sky poop'}\sensenumber{1}\definition{sky}\example{Ddapall a siremang gogon.}{The sky got dark.}\sensenumber{2}\definition{heaven}\example{Ddapall e ibi allan.}{I am going to heaven.}\sensenumber{2}\definition{cloud Pällämpälläm o säresärem. (White or dark.)}\example{Yäbäd de ddapall käkan da dakonewän.}{Clouds covered the sun.}\sensenumber{2}\definition{cloud}\sensenumber{2}\definition{heaven}\example{Ddapall ma da kili ma ttängäm dan.}{Heaven is a place of happiness.}\subentry{\headword{ddapall käkan}\pos{n.}\definition{cloudPällämpälläm o säresärem. (White or dark.)}}\subentry{\headword{ddapall källa}\pos{n.}\definition{cloud}}\subentry{\headword{ddapall ma}\pos{n.}\definition{heaven}}}
...
\entry{Ddele}{\headword{Ddele}\pos{pn.}\etymology{Ddele + =ang}\sensenumber{2}\definition{Ddele (toponym)}\sensenumber{2}\definition{Ende dialect spoken in Ddele}\subentry{\headword{Ddeleag}\pos{pn.}\definition{Ende dialect spoken in Ddele}}}
\entry{Ddelema}{\headword{Ddelema}\pos{pn.}\sensenumber{2}\definition{male personal name}}
\entry{ddia}{\headword{ddia}\pos{n.}\etymology{from Englishdeer}\sensenumber{2}\definition{deer}\example{Ddia da dindu allan.}{The deer is running.}}
\entry{ddob}{\headword{ddob}\pos{quant.}\etymology{ddob + =ang}\sensenumber{1}\definition{some}\example{Ngämira ddob kollba de deyasiyu.}{They gave us (excl.) some fish.}\sensenumber{2}\definition{other}\example{Ako ddob kemibi ttoen a dadeg ngasnen ma da.}{There are also many other things to do.}\sensenumber{2}\definition{some, others}\example{Ddobag a Ende eka de panypeny erallo, ddobag a kllokloe panypeny erallo.}{Some are speaking Ende; others are speaking a mix.}\subentry{\headword{ddobag}\pos{pron.}\definition{some, others}}}
\entry{ddobae}{\headword{ddobae}\pos{adv.}\etymology{ddob + =ae₂, lit. 'particularly'}\sensenumber{2}\definition{very}\example{ddobae mangallang lla}{very strong person}\example{ddobae melemang lla}{very hardworking person}\sensenumber{2}\definition{very, extremely}\example{Bundae ddobaeddobae mikutt gogon.}{Bundae was very, very angry.}\subentry{\headword{ddobaeddobae}\pos{adv.}\definition{very, extremely}}}
...
\entry{ddol}{\headword{ddol}\pos{n.}\etymology{ddol + =ang}\sensenumber{4}\definition{foam, bubbles, gas}\example{Ttongo lla da ddone mullae dan sisor gärep kae ine de gudne nyäng e banzämaeyän, adawatta gärep kae ine da mɨnyi ddol bogon a nyäng de bungolltän.}{A man cannot pour new wine into an old bag, because the wine will become gassy and it will make the bag explode.}\sensenumber{4}\definition{foamy, bubbly, gassy}\subentry{\headword{ddolag}\pos{mod.}\definition{foamy, bubbly, gassy}}}
...
\entry{ddone}{\headword{ddone}\pos{interj.}\sensenumber{1}\definition{no}\example{― Bäne kokok a daden? ― Ddone.}{― Do you have grandchildren? ― No.}\example{Be bogo ddone allan.}{But he said no.}\sensenumber{2}\definition{not}\example{Da bongo ddone kandärmang ekag, bäne ikop a säremang bognegnän.}{If you don't say sorry, you will go blind.}\sensenumber{3}\definition{a\textbackslash_lot}\sensenumber{3}\definition{nothing}\example{Ddone any a lel gogalle.}{She wasn't afraid of anything.}\sensenumber{3}\definition{no one, anyone (nominative form)}\example{Ddone aya mɨnyi ngänäm batramän ttongo ttängäm e.}{No one will take me away to another village.}\sensenumber{3}\definition{accusative form of ddone aya}\example{Ubi ddone amom ikop dägaeyo.}{They didn't see anyone.}\sensenumber{3}\definition{very, a lot (antiphrasis)}\example{Llamda da ddone ada mikutt gogon obo pate.}{The old man got very angry at them.}\subentry{\headword{ddone any}\pos{pron.}\definition{nothing}}\subentry{\headword{ddone aya}\pos{pers. pron.}\definition{no one, anyone (nominative form)}}\subentry{\headword{ddone amom}\pos{pers. pron.}\definition{accusative form of ddone aya}}\subentry{\headword{ddone ada}\pos{adv.}\definition{very, a lot (antiphrasis)}}}
...
\entry{eleben}{\headword{eleben}\pos{num.}\etymology{from Englisheleven}\sensenumber{4}\definition{eleven (English numeral)}}
\entry{elementeri skul}{\headword{elementeri skul}\variant{sp. var. of}{elementri skul}}
\entry{elementri skul}{\headword{elementri skul}\pos{n.}\etymology{from Englishelementary school}\sensenumber{4}\definition{elementary school}}
...
\entry{Em}{\headword{Em}\pos{n.}\etymology{from Emem de 'what (acc.)'}\sensenumber{4}\definition{Em language (Pahoturi River language spoken in Kurunti, Kibuli, Beyambod)}}
...
\entry{Ende}{\headword{Ende}\pos{pn.}\etymology{from Ende ende 'what (acc.)'}\sensenumber{3}\definition{Ende language (Pahoturi River language spoken in Limol, Malam, and Kinkin)}}
...
\entry{enzul}{\headword{enzul}\pos{n.}\etymology{from Englishangel}\sensenumber{3}\definition{angel}}
...
\entry{ergod}{\headword{ergod}\pos{S vi.}\etymology{ergod + =ang}\sensenumber{2}\definition{to crawl}\example{Llɨg kälsre da ergodnen allan.}{The child is crawling.}\sensenumber{2}\definition{toddler}\allomorph{argod}\allomorph{ergodnen}\allomorph{argodaeb}\allomorph{argodmam}\subentry{\headword{ergodag}\pos{n.}\definition{toddler}}}
\entry{eria}{\headword{eria}\pos{n.}\etymology{from Englisharea}\sensenumber{2}\definition{area}\example{Kawam eria me dan oba ttängäm a duli.}{Their land is there, in the Kawam area.}}
...
\entry{ezi}{\headword{ezi}\pos{n.}\etymology{from Englishedge}\sensenumber{2}\definition{sharp edge Ma llo gädanen ma dan. (It's for sharpening house sticks.)}}
...
\entry{gabana}{\headword{gabana}\pos{n.}\etymology{from Englishgovernor}\sensenumber{2}\definition{governor Probins me llayabaene ngällbänatt lla da aya mer ttoen de täbanen anggan. (The person elected by the people in the province who plans good things.)}}
...
\entry{gabma}{\headword{gabma}\pos{n.}\etymology{probably a clipping of gabmantt 'government'}\sensenumber{1}\definition{white person}\example{ttongo gabma bo bin}{a white man's name}\sensenumber{2}\definition{white, Western; foreign}\sensenumber{2}\definition{gun}\subentry{\headword{gabma bägäl}\pos{n.}\definition{gun}}}
\entry{gabman}{\headword{gabman}\variant{var. of}{gabmantt}}
\entry{gabmantt}{\headword{gabmantt}\pos{n.}\etymology{from Englishgovernment}\sensenumber{2}\definition{government}}
...
\entry{gagäll ine}{\headword{gagäll ine}\pos{n.}\etymology{lit. 'bad water'}\sensenumber{3}\definition{beer}}
...
\entry{gambän}{\headword{gambän}\pos{S vi.}\etymology{gambän + -ngg}\sensenumber{3}\definition{to stand}\sensenumber{3}\definition{causative-applicative form of gambän}\example{Ngäna bam danggebänängg.}{I made you stand.}\allomorph{nggebän}\subentry{\headword{gämbanengg}\pos{S vt.}\definition{causative-applicative form of gambän}}}
...
\entry{gän}{\headword{gän}\pos{n.}\etymology{from Englishgun}\sensenumber{2}\definition{gun}}
...
\entry{gärep}{\headword{gärep}\pos{n.}\etymology{from Englishgrape}\sensenumber{2}\definition{grape}}
...
\entry{gita}{\headword{gita}\pos{n.}\etymology{from Englishguitar}\sensenumber{3}\definition{guitar}}
...
\entry{glas}{\headword{glas}\pos{n.}\etymology{from Englishglass}\sensenumber{3}\definition{glass}}
...
\entry{Godd}{\headword{Godd}\pos{pn.}\etymology{from EnglishGod}\sensenumber{3}\definition{God}\example{Godd ibim deyangesnegän.}{God created us (incl.).}}
...
\entry{gol}{\headword{gol}\pos{n.}\etymology{from Englishgoal}\sensenumber{2}\definition{goal}}
...
\entry{greid}{\headword{greid}\pos{n.}\etymology{from Englishgrade}\sensenumber{2}\definition{grade}\example{greid siks me}{in grade six}}
...
\entry{hedmasta}{\headword{hedmasta}\pos{n.}\etymology{from Englishheadmaster}\sensenumber{2}\definition{headmaster}}
...
\entry{Ibru}{\headword{Ibru}\pos{n.}\etymology{from EnglishHebrew}\sensenumber{3}\definition{Hebrew}}
...
\entry{iddpo}{\headword{iddpo}\pos{n.}\etymology{from Kawamidd + ttupo, lit. 'devil skin'}\sensenumber{3}\definition{clothing, clothes}\example{Ttongo mälla da iddpo de nällpäganegnan.}{One woman was hanging the clothes.}\example{Obo iddpo da pällämpälläm a gombenmällnegnän.}{His clothes were white and shining.}}
...
\entry{ist}{\headword{ist}\pos{n.}\etymology{from Englishyeast}\sensenumber{2}\definition{yeast}}
...
\entry{itrell}{\headword{itrell}\pos{n.}\etymology{itrell + =ang}\sensenumber{1}\definition{disease, illness, sickness}\example{Kandärmang säre bablle pätt a ddone abal agan itrell atta.}{Sorry that the illness has made your body so unwell.}\sensenumber{2}\definition{to get hurt}\example{Da ubi gullem de bänglläbaebneyo, ubi mɨnyi ddone buitrellnegnän.}{If they pick up the snakes, they won't get hurt.}\sensenumber{2}\definition{ill, sick}\example{Yesu yuwog abal itrellang lla de ai dägnegnän.}{Jesus healed many sick men.}\subentry{\headword{itrellang}\pos{mod.}\definition{ill, sick}}}
...
\entry{kabkab}{\headword{kabkab}\pos{n.}\etymology{redup. of kab}\sensenumber{3}\definition{type of vine-like plant Wälläng me yuwog dagän, yu patkoll ma dan. (They're plentiful in the bush; it's for bundling wood)}\example{gärep kabkab}{grapevine}}
...
\entry{kala}{\headword{kala}\pos{n.}\etymology{from Englishcolor}\sensenumber{2}\definition{color, pigment, dye}\example{Ngäna ag me kala de yu nägnegan.}{I boiled the pigments in the morning.}}
...
\entry{kampani}{\headword{kampani}\pos{n.}\etymology{from Englishcompany}\sensenumber{2}\definition{company}}
...
\entry{kansel}{\headword{kansel}\pos{n.}\etymology{from Englishcounsel}\sensenumber{4}\definition{counsel}}
...
\entry{kap}{\headword{kap}\pos{n.}\etymology{from Englishcup}\sensenumber{2}\definition{cup}}
...
\entry{kaptte}{\headword{kaptte}\pos{n.}\etymology{from Agobkaboll ttoe, lit. 'devil skin'}\sensenumber{1}\definition{cloth}\example{Mälla da kaptte gullun alle obo bun di dɨmllawän.}{The woman tied her head with an old cloth.}\sensenumber{2}\definition{clothing, clothes; piece of clothing, garment}\example{Kaptte de kotang de ngäsangngäsang de mättnan a mudan.}{Don't wear dirty clothes over and over.}\example{Ngämo kaptte da era komlla dageyo.}{I have two pieces of clothing.}\sensenumber{2}\definition{washing board}\sensenumber{2}\definition{clothes line}\sensenumber{2}\definition{short trousers}\sensenumber{2}\definition{long trousers}\sensenumber{2}\definition{laundry, washing clothes}\example{Lama kamekong gogon kaptte gällämnan me.}{Lama was busy doing the laundry.}\subentry{\headword{kaptte dodro ma}\pos{n.}\definition{washing board}}\subentry{\headword{kaptte ittal ma}\pos{n.}\definition{clothes line}}\subentry{\headword{kaptte tubutubu}\pos{n.}\definition{short trousers}}\subentry{\headword{kaptte tupi}\pos{n.}\definition{long trousers}}\subentry{\headword{kaptte gällämnan}\pos{n.}\definition{laundry, washing clothes}}}
...
\entry{kastom}{\headword{kastom}\pos{n.}\etymology{from Englishcustom}\sensenumber{2}\definition{custom}}
...
\entry{käm1}{\headword{käm1}\pos{n.}\etymology{käm + =ang}\sensenumber{1}\definition{stomach}\example{Ngämo käm a ulle agan.}{I'm full (lit. my stomach got big).}\example{Sɨmell bo käm de dupotän.}{He sliced the pig's stomach open.}\example{Kämang mälla da gänya itrell peyang a mänyi oba käm me llɨg abira basiaemneyo.}{Pregnant women with this disease will give it to their children in their womb.}\sensenumber{2}\definition{womb}\example{Kämang mälla da gänya itrell peyang a mänyi oba käm me llɨg abira basiaemneyo.}{Pregnant women with this disease will give it to their children in their womb.}\sensenumber{2}\definition{pregnant}\example{Da män a kämang allan, ede llɨg a zeg allan.}{If a woman gets preganant, a child will be born.}\subentry{\headword{kämang}\pos{mod.}\definition{pregnant}}}
...
\entry{käp1}{\headword{käp1}\pos{n.}\etymology{käp + =ang}\sensenumber{1}\definition{fruit}\example{Llɨg a llo käp de notan.}{The boy ate the fruit.}\sensenumber{2}\definition{egg}\example{Ge pa da käp tumang zazeag dan.}{This bird lays many eggs.}\sensenumber{3}\definition{vague relatively small and round thing}\example{wayati käp, dädär käp, ttägäll käp, batri käp, tudi käp}{watermelon, rock, money, battery, fish hook}\example{Malla ngäna tumang kollba de naittnegan, tri käpdae.}{I didn't catch many fish, only three.}\sensenumber{4}\definition{nit}\sensenumber{4}\definition{bearing fruit}\example{Tomato da ddone käpang gogon.}{The tomato plant had no fruit.}\subentry{\headword{käpang}\pos{mod.}\definition{bearing fruit}}}
\entry{käp2}{\headword{käp2}\variant{sp. var. of}{kap}}
\entry{käpät}{\headword{käpät}\pos{n.}\etymology{käpät + =ang}\sensenumber{4}\definition{moisture}\sensenumber{4}\definition{wet}\example{Ngämo tater a käptang agan.}{My mat get wet.}\sensenumber{4}\definition{wet, soaked}\example{Bogo walle we guspunän, käsre ma we käptakäptae gongosän.}{He fell in the water, so he came back home soaking wet.}\allomorph{käpt}\subentry{\headword{käpätang}\pos{mod.}\definition{wet}}\subentry{\headword{käpäkäpät}\pos{adv.}\definition{wet, soaked}}}
...
\entry{käzabun}{\headword{käzabun}\pos{n.}\etymology{lit. 'crocodile head'}\sensenumber{2}\definition{large sago flower}}
...
\entry{kemol}{\headword{kemol}\pos{n.}\etymology{from Englishcamel}\sensenumber{2}\definition{camel}}
\entry{kemp}{\headword{kemp}\pos{n.}\etymology{from Englishcamp}\sensenumber{2}\definition{camp}}
...
\entry{ketol}{\headword{ketol}\pos{n.}\etymology{from Englishkettle}\sensenumber{2}\definition{kettle}}
...
\entry{kisin}{\headword{kisin}\pos{n.}\etymology{from Englishkitchen}\sensenumber{2}\definition{kitchen}}
...
\entry{klak1}{\headword{klak1}\pos{n.}\etymology{from Englishclerk}\sensenumber{2}\definition{court clerk Lla da aya darbnen att peba de pänggmeny anggan. (The person who looks after documents.)}}
\entry{klak2}{\headword{klak2}\pos{n.}\sensenumber{2}\definition{type of harpoon for fishing}}
\entry{klas}{\headword{klas}\pos{n.}\etymology{from Englishclass}\sensenumber{2}\definition{class}}
...
\entry{koemekoeme}{\headword{koemekoeme}\pos{n.}\etymology{redup. of koeme}\sensenumber{2}\definition{type of tree that grows along creeks with inedible, small red fruit}}
...
\entry{kokallkokall}{\headword{kokallkokall}\pos{n.}\etymology{redup. of kokall}\sensenumber{2}\definition{type of tree}}
...
\entry{koktakokta}{\headword{koktakokta}\pos{n.}\etymology{redup. of kokta}\sensenumber{2}\definition{when dead trees or tree branches become dry and shine in the night}}
...
\entry{kolos}{\headword{kolos}\pos{n.}\etymology{from Englishcolors}\sensenumber{2}\definition{constable uniform}}
...
\entry{kona}{\headword{kona}\pos{n.}\etymology{from Englishcorner}\sensenumber{1}\definition{corner}\example{Obo ma da duli kona me dan.}{His house is over there, on the corner.}\sensenumber{2}\definition{district, section, area (of a settlement)}\example{Ngäna sisri Llimoll me giddollnen allan Basido kona me.}{I am now living in Limol, in the Basido district.}}
...
\entry{kos}{\headword{kos}\pos{n.}\etymology{from Englishcourse}\sensenumber{2}\definition{course}}
...
\entry{kot1}{\headword{kot1}\pos{n.}\etymology{kot + =ang}\sensenumber{2}\definition{dirt}\sensenumber{2}\definition{dirty, unclean}\example{ttang kotang peyang duwem}{eating with dirty hands}\example{Ngäna sisri kaptte kotang de gällämnan anggan.}{I'm cleaning the dirty clothes now.}\sensenumber{2}\definition{clean, pure}\example{Ngämo umllang dan bongo aenen, bongo Adi bo Kotmeny dan!}{I know who you are; you are God's pure one!}\sensenumber{2}\definition{dirty, unclean}\example{gagäll kotkot anyke}{bad, unclean spirit}\subentry{\headword{kotang}\pos{mod.}\definition{dirty, unclean}}\subentry{\headword{kotmeny}\pos{mod.}\definition{clean, pure}}\subentry{\headword{kotkot}\pos{mod.}\definition{dirty, unclean}}}
\entry{kot2}{\headword{kot2}\variant{var. of}{kwatt}}
\entry{kote}{\headword{kote}\pos{n.}\etymology{lit. 'break the nape'}\sensenumber{2}\definition{nape Bun a wa matta da oba amne me toko dan. (It's in between the head and shoulders and on top.)}\sensenumber{2}\definition{cervical vertebrae}\sensenumber{2}\definition{to hang one's head}\example{Lla da kote gottkamän.}{The man hung his head.}\subentry{\headword{kote kutt}\pos{n.}\definition{cervical vertebrae}}\subentry{\headword{kote ttäkam}\pos{S vi.}\definition{to hang one's head}}}
...
\entry{krismas}{\headword{krismas}\pos{n.}\etymology{from EnglishChristmas}\sensenumber{2}\definition{Christmas}}
...
\entry{ku1}{\headword{ku1}\pos{loc.}\etymology{ku + =ang}\sensenumber{2}\definition{center, core, middle}\example{nyongo ku me}{in the middle of the road}\sensenumber{2}\definition{the ninth stage of coconut growth in which the endosperm of the fruit is fully formed and coconut water remains}\example{Da bongo nge de nängkäl, abo kuang dae nädd.}{Grandfather made me a water bucket.}\subentry{\headword{kuang}\pos{n.}\definition{the ninth stage of coconut growth in which the endosperm of the fruit is fully formed and coconut water remains}}}
...
\entry{kuddäkuddäll}{\headword{kuddäkuddäll}\pos{mod.}\etymology{redup. of kuddäll}\sensenumber{1}\definition{soft}\example{Mätta da kuddällkuddäll bognegän.}{The yams will become soft.}\sensenumber{2}\definition{easy}\example{Orpmang eka da kuddäkuddäll a era ngäna ai dan bondär.}{Wipi language is easy; I can understand it.}\example{Kuddällkuddäll dan baob wätät e.}{It's easy to eat waterlily.}}
\entry{kuddäll}{\headword{kuddäll}\pos{n.}\etymology{lit. 'death passing over'}\sensenumber{1}\definition{death}\example{Gagäll dan lla da bem e buspunän kuddäll e.}{It is bad for a man to throw himself into the ocean to his death.}\sensenumber{2}\definition{to die}\example{Gullem a kuddäll agan.}{The snake died.}\sensenumber{3}\definition{dead}\example{sɨmell kuddäll}{dead pig}\example{kuddäll pätt}{dead body}\sensenumber{4}\definition{abandoned}\example{ma kuddäll, ttängäm kuddäll}{abandoned house, abandoned garden}\sensenumber{4}\definition{Passover}\sensenumber{4}\definition{life-or-death, to death, as if one may die}\example{Kuddäll ttam ngäna dindug.}{I ran for my life.}\example{Ubi kuddäll ttam gotongoenegnän.}{They were laughing to death.}\subentry{\headword{Kuddäll Opap}\pos{pn.}\definition{Passover}}\subentry{\headword{kuddäll ttam}\pos{adv.}\definition{life-or-death, to death, as if one may die}}}
...
\entry{kullkull}{\headword{kullkull}\pos{n.}\etymology{kullkull + =att}\sensenumber{2}\definition{grassfire; burnt grass}\example{Kullkull a dallän llamda pate.}{The grassfire moved towards the old man.}\example{Ngäna deyarne kullkull att dae.}{I was returning to the burnt grass.}\sensenumber{2}\definition{burnt (of an area)}\example{Ttongo däräng a kullkullat enddäna me pollpoll dängkamän.}{A dog started the bark in the burnt-up clearing.}\subentry{\headword{kullkullatt}\pos{mod.}\definition{burnt (of an area)}}}
...
\entry{kum}{\headword{kum}\pos{n.}\etymology{redup. of kum + =att}\sensenumber{1}\definition{buttocks, butt}\sensenumber{2}\definition{abdomen of an insect}\sensenumber{3}\definition{butt, base, bottom, lower or back part of something}\example{Mätta bo kum a angttägan matu ik dae.}{The base of the yam comes up through the ground.}\sensenumber{3}\definition{stinger (of an insect)}\sensenumber{3}\definition{back}\example{Bogo kumattkumatt gongosän.}{He turned and went back.}\subentry{\headword{kumpit}\pos{n.}\definition{stinger (of an insect)}}\subentry{\headword{kumattkumatt}\pos{adv.}\definition{back}}}
...
\lettersection{L}
\entry{labalaba}{\headword{labalaba}\pos{n.}\etymology{ultimately from a Polynesian language; compare Samoan lavalava}\sensenumber{3}\definition{lap-lap}\example{Yäbäd angde ttänttämang abal gogon, däbe lla da obo labalaba de dängkänän ttänttäm atta.}{When the sun got very hot, that man took off his lap-lap because of the heat.}}
...
\entry{laen}{\headword{laen}\pos{n.}\etymology{from Englishline}\sensenumber{2}\definition{line}}
...
\entry{lepresi}{\headword{lepresi}\pos{n.}\etymology{from Englishleprosy}\sensenumber{2}\definition{leprosy}}
...
\entry{lid}{\headword{lid}\pos{n.}\etymology{from Englishlid}\sensenumber{2}\definition{lid}}
\entry{lida}{\headword{lida}\pos{n.}\etymology{from Englishleader}\sensenumber{2}\definition{leader}}
...
\entry{lo}{\headword{lo}\pos{n.}\etymology{from Englishlaw}\sensenumber{2}\definition{law}}
\entry{Lois}{\headword{Lois}\pos{pn.}\sensenumber{2}\definition{female personal name}}
\entry{lok}{\headword{lok}\pos{A vt.}\etymology{from Englishlock}\sensenumber{2}\definition{lock}}
\entry{loli}{\headword{loli}\pos{n.}\etymology{from Englishlolly}\sensenumber{2}\definition{candy}}
...
\entry{lus}{\headword{lus}\pos{A vi.}\etymology{from Englishlose}\sensenumber{2}\definition{lose}}
...
\entry{lläng}{\headword{lläng}\pos{mod.}\etymology{lläng + =meny}\sensenumber{4}\definition{sharp}\example{Ttam a ddobae lläng dag.}{The leaves are very sharp.}\sensenumber{4}\definition{dull, blunt}\example{Gudne giri da llängmeny dan.}{The old knife is dull.}\subentry{\headword{llängmeny}\pos{mod.}\definition{dull, blunt}}}
...
\entry{=mae1}{\headword{=mae1}\pos{n. cl.}\etymology{from =me + =ae₁}\sensenumber{2}\definition{restrictive clitic; only}\example{Ngäna Ende eka walle mae eka allan.}{I only speak in Ende.}}
\entry{=mae2}{\headword{=mae2}\pos{n. cl.}\etymology{from =me + =ae₂}\sensenumber{2}\definition{perlative case clitic; through}\example{Däbe dirom ulle de dazu kuddäll e mae.}{I shot that big cassowary to death.}}
...
\entry{maer}{\headword{maer}\pos{n.}\etymology{from Englishmyrrh}\sensenumber{2}\definition{myrrh}}
...
\entry{mak}{\headword{mak}\pos{n.}\etymology{from Englishmark}\sensenumber{1}\definition{mark}\sensenumber{2}\definition{to choose}\example{Ubi komllaebmae llo de mak dägaeyo.}{They each chose a tree.}}
...
\entry{maket}{\headword{maket}\pos{n.}\etymology{from Englishmarket}\sensenumber{2}\definition{market}\example{Ngäna maket me melemang dan.}{I work in the market.}}
...
\entry{mamall}{\headword{mamall}\pos{adv.}\etymology{mamall + =dae₂}\sensenumber{2}\definition{quickly}\example{Lläkäm a ttongo mamall zozoang dan.}{A mushroom goes rotten quickly.}\sensenumber{2}\definition{immediately, right away}\example{Itrell me mamalldae meresin e gogmallo.}{In sickness, they go for medicine immediately.}\example{Mamalldae wiyamom!}{(You all) come right away!}\sensenumber{2}\definition{quickly}\example{Abo bongo mamamamall ngämim yangkollmällneg.}{You must follow us quickly.}\subentry{\headword{mamalldae}\pos{adv.}\definition{immediately, right away}}\subentry{\headword{mamamamall}\pos{adv.}\definition{quickly}}}
...
\entry{manglle}{\headword{manglle}\pos{A vt.}\etymology{manglle + =ang}\sensenumber{2}\definition{to lure}\example{Ngäna ddia llɨg eka däga adawede oba manglle bäga.}{I made baby deer sounds to lure her.}\sensenumber{2}\definition{friendly, appealing, sociable}\example{Ngäna lla bo peyang mangllong dan.}{I am friendly with people.}\subentry{\headword{mangllong}\pos{mod.}\definition{friendly, appealing, sociable}}}
...
\entry{maret}{\headword{maret}\pos{n.}\etymology{from Englishmarriage}\sensenumber{2}\definition{marriage}}
...
\entry{markae}{\headword{markae}\pos{n.}\etymology{from Taeme}\sensenumber{1}\definition{white person}\sensenumber{2}\definition{white, Western; foreign}\sensenumber{2}\definition{gun}\sensenumber{2}\definition{English}\subentry{\headword{markae bägäl}\pos{n.}\definition{gun}}\subentry{\headword{markae eka}\pos{pn.}\definition{English}}}
...
\entry{mäda}{\headword{mäda}\pos{kin.}\etymology{mäda + ulle, lit. 'older than father'}\sensenumber{1}\definition{father}\example{Ge obo mäda wainen.}{This is his father.}\sensenumber{2}\definition{owner (of an animal)}\example{Däräng a oba mäda Kwalde bäne ibiatt de dongkollmälleyo.}{The dogs followed their owner Kwalde's footprints.}\sensenumber{1}\definition{aunt (one's father's elder sister)}\sensenumber{2}\definition{uncle (one's father's elder brother)}\example{Mädaulle daeya pu wi nallan.}{Uncle went to the swamp garden.}\sensenumber{3}\definition{brother-in-law (woman's husband's elder brother)}\sensenumber{4}\definition{sister-in-law (woman's husband's elder sister or woman's younger brother's wife; reciprocal)}\sensenumber{4}\definition{fatherless}\subentry{\headword{mädaulle}\pos{kin.}\definition{aunt (one's father's elder sister)}}\subentry{\headword{mädameny}\pos{mod.}\definition{fatherless}}}
...
\entry{mäg}{\headword{mäg}\pos{kin.}\etymology{lit. 'older than mother'}\sensenumber{1}\definition{mother Zaze me baba bälle ngäminggag dan. (She helps the father to make a family.)}\example{Ngämo mäg bo bin a Sana.}{My mother's name is Sana.}\sensenumber{2}\definition{source}\example{Ge buk a ibim taempmeny anggan mägda abal eka midd de.}{This book shows us the original meaning.}\sensenumber{2}\definition{aunt (one's father's elder brother's wife)}\sensenumber{2}\definition{motherless}\subentry{\headword{mäg ulle}\pos{kin.}\definition{aunt (one's father's elder brother's wife)}}\subentry{\headword{mägmeny}\pos{mod.}\definition{motherless}}}
...
\entry{mägda}{\headword{mägda}\pos{n.}\etymology{lit. 'the mother'}\sensenumber{2}\definition{coconut body (as opposed to the shoot)}}
...
\entry{mängall}{\headword{mängall}\pos{n.}\etymology{mängall + =meny}\sensenumber{1}\definition{strength, power}\example{Bäne mängall a ulle dan, be ngämo kälsre dan.}{You are stronger than me (lit. your strength is big, but mine is small).}\sensenumber{2}\definition{to struggle}\example{Däbe mälla da ada mängall gognän tudi nyongkoe e.}{That woman was struggling to pull the fishing line.}\sensenumber{3}\definition{poison}\sensenumber{3}\definition{encouragement, cheer}\example{Obo pallall lla da mäse obom mängall eka dägneyo.}{His supporters tried to cheer him on.}\sensenumber{3}\definition{weak}\example{Sisri obo pätt a mängallmeny allan.}{His body is weak now.}\example{Wel ulle da mängallmeny gogon.}{The storm grew weak.}\allomorph{mänga}\subentry{\headword{mängall eka}\pos{n.}\definition{encouragement, cheer}}\subentry{\headword{mängallmeny}\pos{mod.}\definition{weak}}}
...
\entry{medol}{\headword{medol}\pos{n.}\etymology{from Englishmedal}\sensenumber{2}\definition{medal}}
...
\entry{melem}{\headword{melem}\pos{n.}\etymology{melem + =ang}\sensenumber{2}\definition{work}\example{Oba melem dättemäneyo a gongoseyo ma we.}{They finished their work and returned home.}\example{Obo peyang mɨnyi melem bog.}{I will work with her.}\sensenumber{1}\definition{hardworking}\example{Bogo ddobae melemang daeya.}{He was very hardworking.}\sensenumber{2}\definition{servant, laborer}\example{Ttängäm mondrog lla da melemang de dällädeyo a gagagäll duwebeyo.}{The garden workers grabbed the servant and beat him badly.}\subentry{\headword{melemang}\pos{mod.}\definition{hardworking}}}
...
\entry{memba}{\headword{memba}\pos{n.}\etymology{from Englishmember}\sensenumber{2}\definition{member}}
...
\entry{menizment}{\headword{menizment}\pos{n.}\etymology{from Englishmanagement}\sensenumber{2}\definition{management}}
...
\entry{meresin}{\headword{meresin}\pos{n.}\etymology{from Englishmedicine}\sensenumber{3}\definition{medicine}}
...
\entry{miks}{\headword{miks}\pos{n.}\etymology{from Englishmix}\sensenumber{1}\definition{mix, mixture}\example{Ngäma eka da miks ingoll gogon.}{Our (excl.) language has become like a mix.}\sensenumber{2}\definition{to mix}}
\entry{mikutt}{\headword{mikutt}\pos{mod.}\etymology{mikutt + =ang}\sensenumber{2}\definition{angry, mad}\example{Obo mikutt a ttäntämang e gopnaeän.}{His anger made him hot.}\example{Da ttongo lla da bäne za de gämäll bogon, bongo mɨnyi mikutt ag.}{If someone steals your thing, you will be angry.}\example{Yae mikutt allan.}{Mother is mad.}\example{Bogo mikutt gogon.}{He got angry.}\sensenumber{1}\definition{angry, short-tempered}\example{Bogo era ddobae mikuttang lla dan.}{He's a very angry person.}\sensenumber{2}\definition{to hate}\example{Mikuttang eran.}{He hates him.}\sensenumber{2}\definition{calm}\example{Bogo era mikuttmeny lla dan.}{He's a calm fellow.}\subentry{\headword{mikuttang}\pos{mod.}\definition{angry, short-tempered}}\subentry{\headword{mikuttmeny}\pos{mod.}\definition{calm}}}
...
\entry{ministri}{\headword{ministri}\pos{n.}\etymology{from Englishministry}\sensenumber{2}\definition{ministry}}
...
\entry{mista}{\headword{mista}\pos{n.}\etymology{from Englishmister}\sensenumber{2}\definition{mister}}
\entry{mistae}{\headword{mistae}\variant{sp. var. of}{misdae}}
\entry{mit}{\headword{mit}\pos{n.}\etymology{redup. of mit + =ang}\sensenumber{1}\definition{base (of a plant)}\example{Ubi llo mit mi dagaeya.}{They were at the base of the tree.}\sensenumber{2}\definition{reason, sake}\example{Mit a gänyan.}{Here is the reason.}\example{Ttongo lla da säremang ma me daeya kuddäll e lla gäz mit me.}{A man was in prison because he beat someone to death.}\example{Iba mit me däpleon.}{He died for our (incl.) sake.}\sensenumber{3}\definition{origin, source}\example{Ge Ende eka da bo mit eka dan.}{This is the origin story of the Ende language.}\sensenumber{4}\definition{guilt}\sensenumber{4}\definition{to blame}\example{Ngänäm mitamitang dagän.}{They were blaming me.}\subentry{\headword{mitamitang}\pos{A vt.}\definition{to blame}}}
\entry{mitin}{\headword{mitin}\variant{sp. var. of}{miting}}
\entry{miting}{\headword{miting}\pos{n.}\etymology{from Englishmeeting}\sensenumber{4}\definition{meeting}}
...
\entry{moep}{\headword{moep}\pos{n.}\etymology{moep + =ang}\sensenumber{2}\definition{charcoal dust}\sensenumber{1}\definition{matured}\example{Bogo moepang agan.}{He is all grown up.}\sensenumber{2}\definition{charcoal-stained}\subentry{\headword{moepang}\pos{mod.}\definition{matured}}}
...
\entry{mondre}{\headword{mondre}\pos{n.}\etymology{mondre + =ang}\sensenumber{2}\definition{gardening, garden work}\example{Bogo mondre bognän.}{She will be gardening.}\sensenumber{2}\definition{gardener, having a green thumb}\example{Ddobae mondrog lla deya.}{He was a great gardener.}\subentry{\headword{mondreag}\pos{mod.}\definition{gardener, having a green thumb}}}
...
\entry{mullamulla}{\headword{mullamulla}\pos{n.}\etymology{from Hiri Motumuramura}\sensenumber{2}\definition{medicine}}
...
\entry{naen}{\headword{naen}\pos{num.}\etymology{from Englishnine}\sensenumber{2}\definition{nine (English numeral; also general)}}
\entry{naenti}{\headword{naenti}\pos{num.}\etymology{from Englishninety}\sensenumber{2}\definition{ninety}}
\entry{naentin}{\headword{naentin}\pos{num.}\etymology{from Englishnineteen}\sensenumber{2}\definition{nineteen (English numeral)}}
\entry{nag}{\headword{nag}\pos{kin.}\sensenumber{2}\definition{friend}\sensenumber{2}\definition{friendship}\example{Oba nag ttoen a dädme llätt gogon.}{Their friendship ended there.}\sensenumber{2}\definition{nonsingular form of nag}\subentry{\headword{nag ttoen}\pos{n.}\definition{friendship}}\subentry{\headword{nagnag}\pos{n.}\definition{nonsingular form of nag}}}
...
\entry{nes}{\headword{nes}\pos{n.}\etymology{from Englishnurse}\sensenumber{2}\definition{nurse}}
\entry{net}{\headword{net}\pos{n.}\etymology{from Englishnet}\sensenumber{2}\definition{net}\example{Ngäna ttongo net de dirängän ine watt.}{I lifted a net out from the water.}}
\entry{nett}{\headword{nett}\variant{var. of}{net}}
\entry{nidol}{\headword{nidol}\pos{n.}\etymology{from Englishneedle}\sensenumber{2}\definition{needle}}
\entry{nikbin}{\headword{nikbin}\pos{n.}\etymology{partial calque of Englishnickname}\sensenumber{2}\definition{nickname}}
...
\entry{nil}{\headword{nil}\pos{n.}\etymology{from Englishnail}\sensenumber{2}\definition{nail (made of metal)}}
...
\entry{Nugini}{\headword{Nugini}\pos{pn.}\etymology{from Tok PisinHiri MotuNiugini}\sensenumber{2}\definition{New Guinea}}
...
\entry{ngange}{\headword{ngange}\pos{S vt.}\etymology{ngange + =ang}\sensenumber{1}\definition{to communicate, deliver a message}\example{ngangema ttoen}{method of communication}\example{Lla da mɨnyi utt alle eka de bängaeyo.}{Men will deliver the message with the conch shell.}\sensenumber{1}\definition{messenger}\example{Ngangeyang abo umllang dägaeballo aeya kuddäll agan.}{Then the messengers will say who died.}\allomorph{nga}\allomorph{nge}\subentry{\headword{ngangeyang}\pos{n.}\definition{messenger}}}
...
\entry{ngämingg}{\headword{ngämingg}\pos{S vt.}\etymology{ngämingg + =ang}\sensenumber{1}\definition{to help}\example{Lla da ttongo lla de nangminggan towall ttokoe e.}{A man helps another man to cut grass.}\example{Ngäna bam mɨnyi bangmingg.}{I will help you.}\example{Ibi mɨnyi iba mälla de bangmiminyaemnalla.}{We (incl.) will be supporting our women.}\sensenumber{2}\definition{to answer}\example{Bogo do gungminggän ada, "Aoǃ"}{There he answered, "Yesǃ"}\sensenumber{2}\definition{helpful, supportive}\example{Bogo ngäminggag yae dan.}{She is a supportive mother.}\allomorph{ngmingg}\allomorph{ngämiminy}\allomorph{ngmiminy}\allomorph{ngämi}\allomorph{ngmi}\subentry{\headword{ngäminggag}\pos{mod.}\definition{helpful, supportive}}}
...
\entry{ngänaeka}{\headword{ngänaeka}\pos{A vt.}\etymology{redup. of ngänaeka + =ang}\sensenumber{2}\definition{to cry (about, for)}\example{Bongo ewatta ngänaeka alle?}{Why are you crying?}\example{Bom ngänaeka dägagallo.}{They cry for him.}\sensenumber{2}\definition{tear}\sensenumber{2}\definition{crying, in tears}\sensenumber{2}\definition{to burst into tears}\example{Bogo ngänaeka gompllogon.}{He burst into tears.}\sensenumber{2}\definition{nonsingular form of ngänaeka}\example{Tämamae llɨg de papa dägnegnän, ngänaekangänaeka gognän.}{He hit all the boys and they cried.}\subentry{\headword{ngänaeka täräm}\pos{n.}\definition{tear}}\subentry{\headword{ngänaekongänaekong}\pos{adv.}\definition{crying, in tears}}\subentry{\headword{ngänaeka pollongg}\pos{S vi.}\definition{to burst into tears}}\subentry{\headword{ngänaekangänaeka}\pos{A vi.}\definition{nonsingular form of ngänaeka}}}
\entry{ngänam}{\headword{ngänam}\pos{S vt.}\etymology{ngänam + =meny}\sensenumber{1}\definition{to understand, recognize}\example{Ubi mɨnyi eka midd de bängnameyo.}{They will understand the meaning.}\example{Bibi ddone ke ngänaem amalla?}{Don't you all understand?}\example{Bogo gongnamän ada, nagda obom era kuki dägagän.}{He recognized that his friend had deceived him.}\sensenumber{2}\definition{understanding}\sensenumber{2}\definition{unrecognizable, obscure}\example{Ngaskäma Ende eka da mɨnyi ngänameny bogon källkae.}{Maybe the Ende language will become unrecognizable later.}\allomorph{ngnam}\allomorph{ngnaem}\allomorph{ngänaem}\allomorph{ngän}\allomorph{ngn}\subentry{\headword{ngänameny}\pos{mod.}\definition{unrecognizable, obscure}}}
...
\entry{nyingnying}{\headword{nyingnying}\pos{n.}\etymology{redup. of nying}\sensenumber{2}\definition{foundation of fence}}
...
\entry{nyongo taempägag}{\headword{nyongo taempägag}\pos{n.}\etymology{taempäg + =ang, lit. 'way-shower'}\sensenumber{2}\definition{navigator (of a canoe)}}
...
\entry{o klak}{\headword{o klak}\pos{adv.}\etymology{from Englisho'clock}\sensenumber{2}\definition{o'clock}\example{Tri o klak gogän.}{It's three o'clock.}}
...
\entry{ol1}{\headword{ol1}\pos{n.}\etymology{from Englishhall}\sensenumber{2}\definition{hall}}
...
\entry{olib}{\headword{olib}\pos{n.}\etymology{from Englisholive}\sensenumber{2}\definition{olive}}
...
\entry{omäg}{\headword{omäg}\pos{n.}\etymology{omäg + =ang}\sensenumber{2}\definition{magic}\example{omäg ttoen}{sorcery}\example{Digezänän omäg pawa walle.}{He took it out with magic power.}\sensenumber{2}\definition{magician, sorcerer, fortune-teller}\subentry{\headword{omägag}\pos{n.}\definition{magician, sorcerer, fortune-teller}}}
...
\entry{ony}{\headword{ony}\pos{S vt.}\etymology{kom- [ony] + -ngg}\sensenumber{2}\definition{to carry; get; bring}\example{sabi onyang lla}{person who carries out the law}\example{Era ebdo me mɨnyi ibi bobollab ttängäm e mätta kongkom e?}{On which day will we (incl.) go to the garden to get the yams?}\example{Ngämi nge de diwenyeya.}{We (excl.) brought over the coconut.}\example{Bibra otät de aya bikomän?}{Who is bringing over your (pl.) food?}\sensenumber{2}\definition{causative-applicative form of ony (to make carry; bring for, take to; take from)}\example{Grace ngänäm gull de dangkomonggän.}{Grace had me bring the net.}\example{Bong obo pope sɨmell midd de dangkomonggän.}{Bong brought the pork for his uncle.}\example{Ttall a obo za de dangkämonggän.}{The wallaby took her thing.}\allomorph{weny}\allomorph{kongkom}\allomorph{kom}\allomorph{wony}\allomorph{ny}\allomorph{ngkom}\subentry{\headword{komongg}\pos{S vd.}\definition{causative-applicative form of ony (to make carry; bring for, take to; take from)}}}
...
\entry{otät}{\headword{otät}\pos{S vt.}\etymology{lit. 'place for cooking food'}\sensenumber{1}\definition{to eat}\example{Diba toto we, bogo sana dorko de doton.}{That evening, she ate dry sago.}\example{Ubi llo käp otnanang dag.}{They eat tree fruit.}\sensenumber{2}\definition{food}\example{Bogo mer wätät de yu dägagän.}{She cooked nice food.}\sensenumber{3}\definition{hunger}\example{Otät atta ngämo kutt a mängallmeny agmallo.}{My bones became weak from hunger.}\sensenumber{3}\definition{starvation}\sensenumber{3}\definition{kitchen}\sensenumber{3}\definition{edible}\allomorph{ot}\allomorph{wätät}\allomorph{wätat}\allomorph{t}\allomorph{wät}\subentry{\headword{otät ngänaeka ttoen}\pos{n.}\definition{starvation}}\subentry{\headword{otät yu ma}\pos{n.}\definition{kitchen}}\subentry{\headword{otnan ma}\pos{mod.}\definition{edible}}}
...
\entry{paeb}{\headword{paeb}\pos{num.}\etymology{from Englishfive}\sensenumber{3}\definition{five (English numeral)}}
...
\entry{paitt}{\headword{paitt}\pos{n.}\etymology{from Englishfight}\sensenumber{3}\definition{fight}}
...
\entry{palament}{\headword{palament}\pos{n.}\etymology{from Englishparliament}\sensenumber{3}\definition{parliament}}
...
\entry{pama}{\headword{pama}\pos{n.}\etymology{from Englishfarmer}\sensenumber{2}\definition{farmer}}
...
\entry{pani}{\headword{pani}\pos{mod.}\etymology{from Englishfunny}\sensenumber{2}\definition{funny}}
\entry{panis}{\headword{panis}\pos{A vt.}\etymology{from Englishpunish}\sensenumber{2}\definition{to punish}}
...
\entry{paspas}{\headword{paspas}\pos{n.}\etymology{redup. of Englishpass}\sensenumber{3}\definition{type of game where players try to keep a ball off the ground}}
\entry{pasta}{\headword{pasta}\pos{n.}\etymology{from Englishpastor}\sensenumber{3}\definition{pastor Adi bäne eka panypenyang lla sos me. (God's spokesperson in church.)}\example{Ngämi sisri pasta melem de ngasnen eralla.}{Now we are doing pastor work.}}
...
\entry{patarapatara}{\headword{patarapatara}\pos{n.}\etymology{redup. of patara}\sensenumber{3}\definition{type of hand game where players make an L shape with their fingers}}
...
\entry{patrol}{\headword{patrol}\pos{n.}\etymology{from Englishpatrol}\sensenumber{3}\definition{patrol}}
...
\entry{paya}{\headword{paya}\pos{A vt.}\etymology{from Englishfire}\sensenumber{3}\definition{to shoot, fire}}
...
\entry{pälan}{\headword{pälan}\pos{n.}\etymology{from Englishplan}\sensenumber{2}\definition{plan}\example{Mälla da pälan gognegän.}{The women made a plan.}}
...
\entry{pärta}{\headword{pärta}\pos{num.}\etymology{from a Yam language; compare Nen prta}\sensenumber{2}\definition{thirty-six (yam counting numeral; 6\textbackslashtextasciicircum2)}}
...
\entry{peba}{\headword{peba}\pos{n.}\etymology{from Englishpaper}\sensenumber{2}\definition{paper}}
...
\entry{pemli}{\headword{pemli}\pos{n.}\etymology{from Englishfamily}\sensenumber{2}\definition{family}}
\entry{pen}{\headword{pen}\pos{n.}\etymology{from Englishpen}\sensenumber{2}\definition{pen}}
...
\entry{pes}{\headword{pes}\pos{ord. num.}\etymology{from Englishfirst}\sensenumber{2}\definition{first}\example{pes täräp}{the first time}}
...
\entry{pilatt}{\headword{pilatt}\pos{n.}\etymology{from Englishplate}\sensenumber{2}\definition{plate, dish}\example{Ngäna mɨnyi pilatt de bänggllämneg.}{I will wash the dishes.}}
...
\entry{pipti}{\headword{pipti}\pos{num.}\etymology{from Englishfifty}\sensenumber{2}\definition{fifty}}
\entry{piptin}{\headword{piptin}\pos{num.}\etymology{from Englishfifteen}\sensenumber{2}\definition{fifteen (English numeral)}}
...
\entry{pitpit}{\headword{pitpit}\pos{n.}\etymology{from Tok Pisinpitpit}\sensenumber{2}\definition{sugarcane}}
...
\entry{piyepiye}{\headword{piyepiye}\pos{n.}\etymology{redup. of piye}\sensenumber{2}\definition{blister}}
...
\entry{plen}{\headword{plen}\pos{n.}\etymology{from Englishplane}\sensenumber{2}\definition{airplane}\sensenumber{2}\definition{airstrip}\subentry{\headword{plenngätt}\pos{n.}\definition{airstrip}}}
\entry{plenplen}{\headword{plenplen}\pos{n.}\etymology{redup. of plen}\sensenumber{2}\definition{pinwheel}}
...
\entry{po2}{\headword{po2}\pos{num.}\etymology{from Englishfour}\sensenumber{2}\definition{four (English numeral; also general)}}
...
\entry{polis}{\headword{polis}\pos{n.}\etymology{from Englishpolice}\sensenumber{3}\definition{police}\example{Polis a namllamallo ge lla de.}{Police seized this man.}}
...
\entry{pollgo suwe}{\headword{pollgo suwe}\pos{n.}\etymology{lit. 'frog urine'}\sensenumber{3}\definition{dirt left on skin after coming out of the water}\example{Bäne pätt a pollgo suwe peyang dan.}{Your body is covered in dirt from the water.}}
...
\entry{pop}{\headword{pop}\pos{n.}\etymology{pop + =ang}\sensenumber{3}\definition{hole}\example{Tupi ttang llɨpɨt de pop me nowanseg.}{Put your long finger in the hole.}\sensenumber{1}\definition{holey, having a hole}\example{Ine kutt da bo lid a popang dan.}{The lid of the water container has a hole.}\sensenumber{2}\definition{rubbish, darn}\subentry{\headword{popang}\pos{mod.}\definition{holey, having a hole}}}
...
\entry{pos}{\headword{pos}\pos{n.}\etymology{from Englishpost}\sensenumber{2}\definition{post}}
...
\entry{Pot Mosbi}{\headword{Pot Mosbi}\pos{pn.}\etymology{from Tok PisinPot Mosbi}\sensenumber{3}\definition{Port Moresby (the capital city of Papua New Guinea)}}
\entry{poti}{\headword{poti}\pos{num.}\etymology{from Englishforty}\sensenumber{3}\definition{forty}}
\entry{potin}{\headword{potin}\pos{num.}\etymology{from Englishfourteen}\sensenumber{3}\definition{fourteen (English numeral)}}
...
\entry{praede}{\headword{praede}\variant{sp. var. of}{praedde}}
\entry{praedde}{\headword{praedde}\pos{n.}\etymology{from EnglishFriday}\sensenumber{3}\definition{Friday}}
\entry{praemari skul}{\headword{praemari skul}\pos{n.}\etymology{from Englishprimary}\sensenumber{3}\definition{primary school}}
...
\entry{prep}{\headword{prep}\pos{n.}\etymology{clipping of Englishpreparatory}\sensenumber{3}\definition{preparatory school}}
\entry{pri}{\headword{pri}\pos{mod.}\etymology{from Englishfree}\sensenumber{3}\definition{free}}
...
\entry{probens}{\headword{probens}\pos{n.}\etymology{from Englishprovince}\sensenumber{3}\definition{province}}
...
\entry{putt kämamkämam}{\headword{putt kämamkämam}\pos{n.}\etymology{lit. 'folded hoof'}\sensenumber{2}\definition{type of sago bundle wrapped with sago leaves and tied at one end}}
...
\entry{rabis}{\headword{rabis}\pos{n.}\etymology{from Englishrubbish}\sensenumber{2}\definition{rubbish, trash}}
...
\entry{räba}{\headword{räba}\pos{n.}\etymology{from Englishrubber}\sensenumber{2}\definition{rubber; eraser}}
...
\entry{redi}{\headword{redi}\pos{A vt.}\etymology{from Englishready}\sensenumber{2}\definition{to prepare, make ready}}
...
\entry{rop}{\headword{rop}\pos{n.}\etymology{from Englishrope}\sensenumber{2}\definition{rope}}
...
\lettersection{S}
\entry{sabi}{\headword{sabi}\pos{n.}\etymology{possibly from Tok Pisin save 'habit', ultimately from Portuguese saber 'know'}\sensenumber{1}\definition{law, rule}\example{Ngämi bam da batrameya, abo bongo ge sabi de nongkollmäll.}{We will take you, but you must follow these rules.}\sensenumber{2}\definition{taboo}\example{Ngämo mänang a ngänäm de aläm bagneyo ada, ngämo bin ttam a mudan, sabi.}{My in-laws will be warning me that it's taboo to call me by my name.}}
\entry{sabol}{\headword{sabol}\pos{n.}\etymology{from Englishshovel}\sensenumber{2}\definition{shovel, spade Ttängäm gllaenen ma dan. (It's for digging the garden.)}}
...
\entry{sae}{\headword{sae}\pos{S vt.}\etymology{sae + =ang}\sensenumber{1}\definition{to close, cover}\example{Nga bongo ikop nasǃ}{You, close your eyes!}\example{Däräng a ikop dasän.}{The dog closed his eyes.}\sensenumber{2}\definition{to extinguish, put out}\example{Yu da saemeny dan.}{The fire isn't put out.}\sensenumber{2}\definition{closed}\example{Däräng täräpang dagirnän ikop saeyang.}{The dog stayed there a long time, eyes closed.}\allomorph{s}\subentry{\headword{saeyang}\pos{mod.}\definition{closed}}}
...
\entry{saen}{\headword{saen}\pos{n.}\etymology{from Englishsign}\sensenumber{2}\definition{sign}\example{Mälla da saen dangesän.}{The woman made a sign.}}
\entry{saeten}{\headword{saeten}\pos{pn.}\etymology{from EnglishSatan}\sensenumber{2}\definition{Satan}}
...
\entry{saks}{\headword{saks}\pos{n.}\etymology{from Englishsocks}\sensenumber{2}\definition{socks}}
...
\entry{sanasana}{\headword{sanasana}\pos{n.}\etymology{redup. of sana}\sensenumber{2}\definition{type of edible sago Sanawang me päddabag za dan, ttam kloklong.}}
...
\entry{sande}{\headword{sande}\pos{n.}\etymology{from EnglishSunday}\sensenumber{1}\definition{Sunday}\sensenumber{2}\definition{week}\example{Lla da ttongo sande makäp me mɨnyi täre we gonsärbemamalle.}{People will be preparing for the feast for a week.}}
...
\entry{sari}{\headword{sari}\pos{interj.}\etymology{from Englishsorry}\sensenumber{2}\definition{sorry}}
...
\entry{satade}{\headword{satade}\pos{n.}\etymology{from EnglishSaturday}\sensenumber{2}\definition{Saturday}}
...
\entry{sawasap}{\headword{sawasap}\pos{n.}\etymology{from Englishsour sap}\sensenumber{2}\definition{type of cultivated tree with edible yellow or green fruit}}
...
\entry{särem}{\headword{särem}\pos{n.}\etymology{särem + =ang}\sensenumber{3}\definition{darkness, dark}\example{ag särem me}{at dawn (lit. in the dark of morning)}\example{Särem a dangttanän ttängäm de.}{Darkness came over the village.}\sensenumber{3}\definition{dark, dim}\example{Iddob me ttängäm a säremang abal gogän.}{At night, the village became very dark.}\example{Llamäg o mällause täräp me iba ikop a mɨnyi säremang bognegän.}{In old age, our (incl.) eyes will go dim.}\sensenumber{3}\definition{cloudy, dim}\sensenumber{3}\definition{in darkness, in the dark}\example{Ngämi säremsärem giddollnenang dagaeya.}{We (excl.) were living in darkness.}\subentry{\headword{säremang}\pos{mod.}\definition{dark, dim}}\subentry{\headword{säresäremang}\pos{mod.}\definition{cloudy, dim}}\subentry{\headword{säremsärem}\pos{adv.}\definition{in darkness, in the dark}}}
\entry{säremang ma}{\headword{säremang ma}\pos{n.}\etymology{lit. 'dark house'}\sensenumber{3}\definition{prison, jail}}
...
\entry{seben}{\headword{seben}\pos{num.}\etymology{from Englishseven}\sensenumber{2}\definition{seven (English numeral; also general)}}
\entry{sebenti}{\headword{sebenti}\pos{num.}\etymology{from Englishseventy}\sensenumber{2}\definition{seventy}}
\entry{sebentin}{\headword{sebentin}\pos{num.}\etymology{from Englishseventeen}\sensenumber{2}\definition{seventeen (English numeral)}}
...
\entry{sek}{\headword{sek}\pos{A vt.}\etymology{from Englishcheck}\sensenumber{2}\definition{to check}\example{Ngämo nyäng sek nägaeyo.}{[You all] check my bag.}}
\entry{sel1}{\headword{sel1}\pos{n.}\etymology{from Englishcell}\sensenumber{2}\definition{cell}\example{Polis a namllamallo lla de ngämo gänye nätramallo, sel ma ik i nazänallo.}{The police took my husband and put him in the cell.}}
\entry{sel2}{\headword{sel2}\pos{A vt.}\etymology{from Englishsell}\sensenumber{2}\definition{to sell}\example{Bogo obo otät de sel anggan.}{He's selling his food.}}
...
\entry{sem2}{\headword{sem2}\pos{mod.}\etymology{from Englishsame}\sensenumber{2}\definition{same}\example{sem ekawang lla}{person who speaks the same language}}
\entry{sens}{\headword{sens}\pos{A vi. \textbackslash& vt.}\etymology{from Englishchange}\sensenumber{1}\definition{to change}\example{Bin a sens gogon.}{The name changed.}\example{Eka kutt di sens erallo.}{They are changing the word.}\sensenumber{2}\definition{to exchange (in marriage)}\example{Obom sens dägagän.}{He exchanged her for marriage.}\allomorph{sensens}}
...
\entry{siks}{\headword{siks}\pos{num.}\etymology{from Englishsix}\sensenumber{3}\definition{six (English numeral; also general)}}
\entry{siksti}{\headword{siksti}\pos{num.}\etymology{from Englishsixty}\sensenumber{3}\definition{sixty}}
\entry{sikstin}{\headword{sikstin}\pos{num.}\etymology{from Englishsixteen}\sensenumber{3}\definition{sixteen (English numeral)}}
...
\entry{sip1}{\headword{sip1}\pos{n.}\etymology{from Englishsheep}\sensenumber{3}\definition{sheep}\example{Ibi sisiri Yesu bo sip dag.}{We are now Jesus' sheep.}}
\entry{sip2}{\headword{sip2}\pos{n.}\etymology{from Englishchief}\sensenumber{3}\definition{chief}}
...
\entry{sisel}{\headword{sisel}\pos{n.}\etymology{from Englishchisel}\sensenumber{3}\definition{chisel Ma llo tranen ma dan. (It's for carving out logs for houses.)}}
...
\entry{siti}{\headword{siti}\pos{n.}\etymology{from Englishcity}\sensenumber{2}\definition{city}}
...
\entry{sɨmell källamokott}{\headword{sɨmell källamokott}\pos{n.}\etymology{lit. 'hard pig poop'}\sensenumber{2}\definition{type of spiky tree that grows in the bush with white flowers, yellow fruit, and hardwood used for firewood}}
\entry{sɨmellkom}{\headword{sɨmellkom}\pos{n.}\etymology{sɨmell + kom, lit. 'pig hair'}\sensenumber{2}\definition{type of sago Ulle päddab sana dan, ddobae mägag dan.}}
\entry{sɨmellmak}{\headword{sɨmellmak}\pos{n.}\etymology{sɨmell + mak, lit. 'pig mark'}\sensenumber{2}\definition{weaving pattern with arrows pointing right}}
...
\entry{skul}{\headword{skul}\pos{n.}\etymology{from Englishschool}\sensenumber{2}\definition{school; education}\sensenumber{2}\definition{student}\sensenumber{2}\definition{educated}\subentry{\headword{skulang}\pos{n.}\definition{student}}\subentry{\headword{skulatt}\pos{mod.}\definition{educated}}}
...
\entry{sod}{\headword{sod}\pos{n.}\etymology{from Englishshirt}\sensenumber{2}\definition{shirt}}
...
\entry{soka}{\headword{soka}\pos{n.}\etymology{from Englishsoccer}\sensenumber{2}\definition{soccer}}
...
\entry{solt}{\headword{solt}\pos{n.}\etymology{from Englishsalt}\sensenumber{2}\definition{salt}}
...
\entry{sos}{\headword{sos}\pos{n.}\etymology{from Englishchurch}\sensenumber{3}\definition{church}\example{Tämamae wiyamom sos e.}{Everyone, come to church.}}
...
\entry{spun1}{\headword{spun1}\pos{n.}\etymology{from Englishspoon}\sensenumber{3}\definition{spoon}}
...
\entry{stoa}{\headword{stoa}\pos{n.}\etymology{from Englishstore}\sensenumber{4}\definition{store}\example{Gull tupi di stoa me llädnan amallo.}{They bought long nets in the store.}}
\entry{stori}{\headword{stori}\pos{n.}\etymology{from Englishstory}\sensenumber{4}\definition{story}}
...
\entry{suga}{\headword{suga}\pos{n.}\etymology{from Englishsugar}\sensenumber{2}\definition{sugar}}
...
\entry{susu}{\headword{susu}\pos{n.}\etymology{from Tok Pisinsusu, ultimately from Malay susu}\sensenumber{2}\definition{breastmilk}}
...
\entry{taem}{\headword{taem}\pos{n.}\etymology{from Englishtime}\sensenumber{2}\definition{time}\example{ddob taem me}{sometimes}}
...
\entry{talapia}{\headword{talapia}\pos{n.}\etymology{from Englishtilapia}\sensenumber{2}\definition{tilapia}}
...
\entry{tameny}{\headword{tameny}\pos{S vt.}\etymology{tameny + =ang}\sensenumber{1}\definition{to teach}\example{Ngäna bam bantemeny walle gllangglla de.}{I'm going to teach you to swim.}\example{Yesu ubira yuwog abal ttoen de sanawang eka walle däntamenynegnän.}{Jesus was teaching them many things using parables.}\sensenumber{2}\definition{to dicuss, converse}\sensenumber{3}\definition{to tell; converse with, speak to}\sensenumber{3}\definition{teacher}\allomorph{ntameny}\allomorph{ntemeny}\allomorph{ntemenyam}\subentry{\headword{tamenyang}\pos{n.}\definition{teacher}}}
...
\entry{taosen}{\headword{taosen}\pos{num.}\etymology{from Englishthousand}\sensenumber{2}\definition{thousand}\example{ttongo taosen tukituki}{more than one thousand}}
\entry{tap1}{\headword{tap1}\pos{A vt.}\etymology{tap + =ma}\sensenumber{2}\definition{to dock, land}\example{Gall de tap dägageya wa ma we deyareya inu we.}{We docked the boat and returned home to sleep.}\sensenumber{2}\definition{dock, wharf}\example{Ubi mängalae gall tapma we dagllaeyo.}{We (incl.) paddled quickly to the canoe dock.}\subentry{\headword{tapma}\pos{n.}\definition{dock, wharf}}}
...
\entry{tarmekälla}{\headword{tarmekälla}\pos{n.}\etymology{tarme + källa, lit. 'kookaburra poop'}\sensenumber{2}\definition{type of taro}}
\entry{taromba}{\headword{taromba}\pos{num.}\etymology{from a Yam language; compare Nen taromba}\sensenumber{2}\definition{216 (yam counting numeral; 6\textbackslashtextasciicircum3)}}
...
\entry{täme käp}{\headword{täme käp}\pos{n.}\etymology{lit. 'lizard egg'}\sensenumber{2}\definition{type of round yam with a white interior, red skin, and hairs}}
...
\entry{täp1}{\headword{täp1}\pos{n.}\etymology{lit. 'shoot that has emerged'}\sensenumber{2}\definition{sago shoot}\example{Sana täp a tupi dan.}{The sago shoot is long.}\sensenumber{2}\definition{the fourth stage of sago growth in which the shoot emerges, indicating the pith is ready to be harvested}\example{Masar tätäm täp gazenatt sana de nagda bälle dantepägän.}{Yesterday, grandfather showed a flowering sago to his friend.}\subentry{\headword{täp gazenatt}\pos{n.}\definition{the fourth stage of sago growth in which the shoot emerges, indicating the pith is ready to be harvested}}}
...
\entry{tärabol}{\headword{tärabol}\pos{n.}\etymology{from Englishtrouble}\sensenumber{2}\definition{trouble}}
...
\entry{tärpam}{\headword{tärpam}\pos{S vt.}\etymology{tärpam + =att}\sensenumber{1}\definition{to put across}\example{Ubi yuwog abal llo de datärpaemaemeyo walle me.}{They put many sticks across the water.}\sensenumber{2}\definition{to crucify}\example{Ubi Yesu bom datärpameyo.}{They crucified Jesus.}\sensenumber{2}\definition{cross}\example{llo tärpamatt toko me}{on top of the wooden cross}\allomorph{tärp}\subentry{\headword{tärpamatt}\pos{n.}\definition{cross}}}
...
\entry{teks}{\headword{teks}\pos{n.}\etymology{from Englishtax}\sensenumber{2}\definition{tax}\example{teks mani ngällbänanang lla}{tax collector}}
\entry{Teme}{\headword{Teme}\variant{dial. var. of}{Tame}}
\entry{ten}{\headword{ten}\pos{num.}\etymology{from Englishten}\sensenumber{2}\definition{ten (English numeral, also general)}}
...
\entry{tesde}{\headword{tesde}\pos{n.}\etymology{from EnglishThursday}\sensenumber{2}\definition{Thursday}}
\entry{teste}{\headword{teste}\variant{sp. var. of}{tesde}}
\entry{teti}{\headword{teti}\pos{num.}\etymology{from Englishthirty}\sensenumber{2}\definition{thirty}}
\entry{tetin}{\headword{tetin}\pos{num.}\etymology{from Englishthirteen}\sensenumber{2}\definition{thirteen (English numeral)}}
...
\entry{tibi}{\headword{tibi}\pos{n.}\etymology{from EnglishTB}\sensenumber{2}\definition{tuberculosis}}
...
\entry{tikop}{\headword{tikop}\pos{n.}\etymology{tikop + =meny, lit. 'heartless'}\sensenumber{1}\definition{heart}\sensenumber{2}\definition{beloved, sweetheart, dear}\sensenumber{2}\definition{startled, scared}\example{Lla da ttongo lla de aiyei abal tikopmeny nägagan.}{The man really scared the other man.}\example{Madura tikopmeny gogän.}{Madura was startled.}\subentry{\headword{tikopmeny}\pos{mod.}\definition{startled, scared}}}
...
\entry{tintromoltintromol}{\headword{tintromoltintromol}\pos{n.}\etymology{redup. of tintromol}\sensenumber{2}\definition{type of rhyming game}}
...
\entry{toelet}{\headword{toelet}\pos{n.}\etymology{from Englishtoilet}\sensenumber{2}\definition{toilet}}
...
\entry{tomato}{\headword{tomato}\pos{n.}\etymology{from Englishtomato}\sensenumber{2}\definition{tomato}}
...
\entry{topotopoll}{\headword{topotopoll}\pos{n.}\etymology{redup. of topoll}\sensenumber{3}\definition{type of tree that grows in the bush with white flowers; used as a yam stick}}
...
\entry{torwam}{\headword{torwam}\pos{S vi.}\etymology{torwam + -ngg}\sensenumber{1}\definition{to lie down}\example{tät me torwamang lla}{man lying down on a stretcher}\example{Ngäna torwam allan.}{I am lying down.}\sensenumber{2}\definition{to lay down}\example{Ngäna obom buntruwam.}{I will lay him down.}\sensenumber{2}\definition{causative-applicative form of torwam}\example{Ngäna bam dantruwamängg.}{I made you lie down.}\allomorph{ntruwam}\allomorph{truwam}\subentry{\headword{torwamängg}\pos{S vt.}\definition{causative-applicative form of torwam}}}
\entry{tos}{\headword{tos}\pos{n.}\etymology{from Englishtorch}\sensenumber{2}\definition{(Commonwealth) torch, (US) flashlight}\example{Ngäna tos de dɨs.}{I turned off the flashlight.}}
...
\entry{towall}{\headword{towall}\pos{n.}\etymology{towall + =ang}\sensenumber{2}\definition{grass}\example{Ttall a towall wätätang dan.}{Wallabies are grass eaters.}\sensenumber{2}\definition{grassy}\example{Ge ttängäm a towallang dan.}{This village is grassy.}\subentry{\headword{towallang}\pos{mod.}\definition{grassy}}}
...
\entry{traeb}{\headword{traeb}\pos{n.}\etymology{from Englishtribe}\sensenumber{2}\definition{tribe}}
\entry{traib}{\headword{traib}\variant{sp. var. of}{traeb}}
\entry{trak1}{\headword{trak1}\pos{n.}\etymology{from Englishtruck}\sensenumber{2}\definition{truck}}
...
\entry{tri}{\headword{tri}\pos{num.}\etymology{from Englishthree}\sensenumber{2}\definition{three (English numeral)}}
\entry{trik}{\headword{trik}\pos{n.}\etymology{from Englishtrick}\sensenumber{2}\definition{trick}}
...
\entry{tu}{\headword{tu}\pos{num.}\etymology{from Englishtwo}\sensenumber{2}\definition{two (English numeral)}}
...
\entry{tubu2}{\headword{tubu2}\pos{n.}\etymology{tubu + kätt}\sensenumber{2}\definition{knee}\example{Ngämo yae obo tubu da apte gagäll dan.}{One of my mother's knees is bad.}\sensenumber{2}\definition{kneecap}\sensenumber{2}\definition{kneeling, on one's knees, on the ground; worshipping}\example{Bogo tubutubu gogon, obo ingoll alle ttäle dowae me.}{He kneeled, his face by her feet.}\example{Zuu lla da Sabat ebdo me sipel gognegnän a Adi pate tubutubu gognegnän.}{The Jews rested and worshipped God on the Sabbath.}\subentry{\headword{tubukätt}\pos{n.}\definition{kneecap}}\subentry{\headword{tubutubu3}\pos{mod.}\definition{kneeling, on one's knees, on the ground; worshipping}}}
...
\entry{tuk}{\headword{tuk}\pos{n.}\etymology{redup. of tuk + =e₁}\sensenumber{1}\definition{air}\example{Ngäna tuk i pipllugag dan.}{I fly into the air.}\sensenumber{2}\definition{top}\example{Gänya anykeanyke da gänyan tuk mi.}{This picture is on top.}\sensenumber{2}\definition{technical university, university}\sensenumber{1}\definition{uphill}\sensenumber{2}\definition{more than, above, over}\example{ttongo taosen tukituki}{more than one thousand}\subentry{\headword{tuk skul}\pos{n.}\definition{technical university, university}}\subentry{\headword{tukituki}\pos{adv.}\definition{uphill}}}
...
\entry{tusde}{\headword{tusde}\pos{n.}\etymology{from EnglishTuesday}\sensenumber{2}\definition{Tuesday}}
\entry{tutu1}{\headword{tutu1}\pos{n.}\etymology{tutu + =ang}\sensenumber{1}\definition{mountain, hill}\example{Ngängälätt dädär a mänyi tutu atta bolldaeyän kopek e.}{The round rock will roll from the hill into the valley.}\sensenumber{2}\definition{land}\example{Tutu wi darullgoeya käza de gull peyang.}{We dragged the crocodile onto land with the net.}\sensenumber{2}\definition{steep}\sensenumber{2}\definition{nonsingular form of tutu}\example{Tutututu da dag.}{There are mountains.}\subentry{\headword{tutuang}\pos{mod.}\definition{steep}}\subentry{\headword{tutututu}\pos{n.}\definition{nonsingular form of tutu}}}
...
\entry{twelb}{\headword{twelb}\pos{num.}\etymology{from Englishtwelve}\sensenumber{2}\definition{twelve (English numeral)}}
\entry{twelve}{\headword{twelve}\variant{sp. var. of}{twelb}}
\entry{twenti}{\headword{twenti}\pos{num.}\etymology{from Englishtwenty}\sensenumber{2}\definition{twenty}}
...
\entry{ttall källa}{\headword{ttall källa}\pos{n.}\etymology{lit. 'wallaby poop'}\sensenumber{2}\definition{brahminy kite Tuk me ngälngälang pa ulle dan. (It's a big bird that circles in the air.)}}
...
\entry{ttall ttoe}{\headword{ttall ttoe}\pos{n.}\etymology{lit. 'wallaby skin'}\sensenumber{2}\definition{type of tree}}
...
\entry{ttattle}{\headword{ttattle}\pos{n.}\etymology{ttattle + =ang}\sensenumber{2}\definition{pain}\example{Bogo ttattle de umllang gogän.}{He felt pain.}\sensenumber{2}\definition{sore, in pain; sick, ill}\subentry{\headword{ttattleang}\pos{mod.}\definition{sore, in pain; sick, ill}}}
...
\entry{upma}{\headword{upma}\pos{n.}\etymology{up + =ma}\sensenumber{3}\definition{two friends who share a twin banana fruit Ittma bin llayaba; mällayaba ttaem. (Ceremonial term for someone; amongst women.)}}
...
\entry{uttang ttatta}{\headword{uttang ttatta}\pos{n.}\etymology{utt + =ang}\sensenumber{3}\definition{type of sago Täkällang ulle pättang sana dan. (It's a thorny sago with a big trunk.)}}
...
\entry{waeya}{\headword{waeya}\pos{n.}\etymology{from Englishwire}\sensenumber{2}\definition{wire}\example{Ngäna nyäng tär ngasnges e nyäng de napoenan waeya kälsre alle.}{I used the small wire to make holes in the bag to put the new bag string.}}
...
\entry{wan}{\headword{wan}\pos{num.}\etymology{from Englishone}\sensenumber{2}\definition{one (English numeral)}}
\entry{wan pinga}{\headword{wan pinga}\pos{n.}\etymology{from Englishone finger}\sensenumber{2}\definition{metal fish spear}}
...
\entry{waramakae}{\headword{waramakae}\pos{num.}\etymology{from a Yam language; compare Arammba wermeke}\sensenumber{2}\definition{7776 (yam counting numeral; 6\textbackslashtextasciicircum5)}}
...
\entry{wel}{\headword{wel}\pos{n.}\etymology{lit. 'wind door'}\sensenumber{2}\definition{wind}\example{Känazbag mänyi wel peyang bogon.}{Tomorrow, it will be windy.}\sensenumber{2}\definition{window}\subentry{\headword{wel ud}\pos{n.}\definition{window}}}
...
\entry{wik}{\headword{wik}\pos{n.}\etymology{from Englishweek}\sensenumber{2}\definition{week}}
...
\entry{win}{\headword{win}\pos{n.}\etymology{from Englishwin}\sensenumber{2}\definition{win}}
\entry{Wini}{\headword{Wini}\variant{sp. var. of}{Winny}}
\entry{winisde}{\headword{winisde}\pos{n.}\etymology{from EnglishWednesday}\sensenumber{2}\definition{Wednesday}}
...
\entry{wit}{\headword{wit}\pos{n.}\etymology{from Englishwheat}\sensenumber{2}\definition{wheat}}
...
\entry{wodd memba}{\headword{wodd memba}\pos{n.}\etymology{from Englishward member}\sensenumber{2}\definition{ward member Llayabaene moko eka de aya komnen agan. (The one who takes what the people want to say.)}}
...
\entry{yad}{\headword{yad}\pos{n.}\etymology{from Englishyard}\sensenumber{2}\definition{yard}}
...
\entry{Yao}{\headword{Yao}\pos{pn.}\etymology{from Taemeyao 'no'}\sensenumber{2}\definition{Taeme language}}
...
\entry{yäbäd källa}{\headword{yäbäd källa}\pos{n.}\etymology{lit. 'sun poop'}\sensenumber{2}\definition{type of big taro}}
...
\entry{yäbäyäbäd}{\headword{yäbäyäbäd}\pos{n.}\etymology{redup. ofyäbäd}\sensenumber{1}\definition{type of tree that grows in the bush with white flowers and red fruit}\sensenumber{2}\definition{type of grass}}
...
\entry{yäkäl}{\headword{yäkäl}\pos{kin.}\etymology{probably from yäkäl + mäda}\sensenumber{2}\definition{cousin}\sensenumber{2}\definition{uncle (one's mother's sister's husband)}\subentry{\headword{yäkälnda}\pos{kin.}\definition{uncle (one's mother's sister's husband)}}}
...
\entry{yunipom}{\headword{yunipom}\pos{n.}\etymology{from Englishuniform}\sensenumber{3}\definition{uniform}}
...
\entry{yus}{\headword{yus}\pos{A vt.}\etymology{from Englishuse}\sensenumber{3}\definition{to use}\example{Kumuddäga eka de ngäna yus anggan.}{I use three languages.}}
...
\entry{zämllall}{\headword{zämllall}\pos{A vi.}\etymology{zämllall + =ang}\sensenumber{2}\definition{to pass by}\example{Bogo zämllall allan.}{He is passing by.}\sensenumber{2}\definition{passerby}\sensenumber{2}\definition{nonstop}\example{Bogo zämllazämllall ibi allan.}{He walks without stopping.}\subentry{\headword{zämllallang}\pos{n.}\definition{passerby}}\subentry{\headword{zämllazämllall}\pos{adv.}\definition{nonstop}}}
...
\entry{zel}{\headword{zel}\pos{n.}\etymology{from Englishjail}\sensenumber{2}\definition{jail}\example{Obom zel ma ik i näzanallo.}{They put him in jail.}}
\entry{Zelma}{\headword{Zelma}\pos{pn.}\sensenumber{2}\definition{female personal name}}
\entry{zem}{\headword{zem}\pos{n.}\etymology{from Englishgerm}\sensenumber{2}\definition{germ}}
...
\entry{zobo ik}{\headword{zobo ik}\pos{n.}\etymology{lit. 'bowerbird's inside'}\sensenumber{2}\definition{walling (bark on house between sago walls and roof)}}
